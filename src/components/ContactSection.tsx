      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex justify-center fade-up">
            <div className="w-56 h-72 sm:w-72 sm:h-80 blob-shape bg-surface-elevated gold-border flex items-center justify-center floating-blob overflow-hidden">
              <img
                src="/contact.png"
                alt="Contact"
          ...
          <div className="fade-up fade-up-delay-2">
            ...
            <div className="space-y-5">
              {contactDetails.map((item) => (
                <div key={item.label} className="flex items-start gap-4 w-full">
                  ...
                  <div className="flex-1">
                    ...
                    {/* 🔥 FIXED OVERFLOW HERE */}
                    <p className="text-foreground break-all leading-relaxed">
                      {item.value}
                    </p>
                  </div>
